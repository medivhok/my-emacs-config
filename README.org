...
:END:
:CONTENTS:
- [[#bootstrapping-the-big-bang][Bootstrapping (The Big Bang)]]
  - [[#profiling][Profiling]]
...
* Bootstrapping (The Big Bang)
:PROPERTIES:
:header-args:emacs-lisp: :noweb-ref init:bootstrapping :noweb-sep "\n\n"
:END:
...
* Personalization
:PROPERTIES:
:header-args:emacs-lisp: :noweb-ref init:personalization
:END:

** Personnal Infos
*** ~user-full-name~
:PROPERTIES:
:variable-name: user-full-name
:variable-url: https://www.gnu.org/software/emacs/manual/html_node/elisp/User-Identification.html
:END:
...
*** ~user-mail-address~
:PROPERTIES:
:variable-name: user-mail-address
:variable-url: https://www.gnu.org/software/emacs/manual/html_node/elisp/User-Identification.html
:END:
...
* User Interface
:PROPERTIES:
:header-args:emacs-lisp: :noweb-ref init:user-interface
:END:
** Theme
...
* Applications
:PROPERTIES:
:header-args:emacs-lisp: :noweb-ref init:applications
:END:
** Org Mode
*** ~org~
:PROPERTIES:
...
*** ~ob-tangle~
:PROPERTIES:
:custom_id: applications--org-mode--ob-tangle
:END:
...
To configure my slip box, I use the [[https://orgroam.com][org-roam]] ecosystem.
...
#+begin_src emacs-lisp :noweb-ref use-package:org-roam:init
...
**** ~org-roam~
:PROPERTIES:
:custom_id: applications--taking-smart-notes--org-roam
...
#+begin_src emacs-lisp :noweb-ref taking-smart-notes
...
* Tools
:PROPERTIES:
:header-args:emacs-lisp: :noweb-ref init:tools
:END:
** Completions
*** Company & Co
...
* Languages
:PROPERTIES:
:header-args:emacs-lisp: :noweb-ref init:languages
:END:
** CSS
...
#+begin_src sh :tangle builddocs.sh
#!/bin/sh
